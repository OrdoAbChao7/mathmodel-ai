...
- Extended the non-dictionary manual-score regression matrix to include falsy values: `[]`, `""`, `0`, and `False`.
- Changed `score_quality()` manual handling so only `manual is None` is treated as omitted input.
- Changed `_validate_manual()` to reject every non-dict manual payload, including falsy non-dict payloads, with controlled `manual_review: INVALID`, `release_status: FAIL`, and `manual_errors`.
...
test_manual_scores_reject_non_dict_inputs_without_crashing (test_quality.QualityTests.test_manual_scores_reject_non_dict_inputs_without_crashing) ... 
  test_manual_scores_reject_non_dict_inputs_without_crashing (test_quality.QualityTests.test_manual_scores_reject_non_dict_inputs_without_crashing) (manual=[]) ... FAIL
  test_manual_scores_reject_non_dict_inputs_without_crashing (test_quality.QualityTests.test_manual_scores_reject_non_dict_inputs_without_crashing) (manual='') ... FAIL
  test_manual_scores_reject_non_dict_inputs_without_crashing (test_quality.QualityTests.test_manual_scores_reject_non_dict_inputs_without_crashing) (manual=0) ... FAIL
  test_manual_scores_reject_non_dict_inputs_without_crashing (test_quality.QualityTests.test_manual_scores_reject_non_dict_inputs_without_crashing) (manual=False) ... FAIL
...
======================================================================
FAIL: test_manual_scores_reject_non_dict_inputs_without_crashing (test_quality.QualityTests.test_manual_scores_reject_non_dict_inputs_without_crashing) (manual=[])
----------------------------------------------------------------------
Traceback (most recent call last):
  File "E:\Projects\school\mathmodel\mathmodel-skill\tests\test_quality.py", line 394, in test_manual_scores_reject_non_dict_inputs_without_crashing
    self.assertEqual(scored["manual_review"], "INVALID")
    ~~~~~~~~~~~~~~~~^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
AssertionError: 'PENDING' != 'INVALID'
- PENDING
+ INVALID
...
======================================================================
FAIL: test_manual_scores_reject_non_dict_inputs_without_crashing (test_quality.QualityTests.test_manual_scores_reject_non_dict_inputs_without_crashing) (manual=0)
----------------------------------------------------------------------
Traceback (most recent call last):
  File "E:\Projects\school\mathmodel\mathmodel-skill\tests\test_quality.py", line 394, in test_manual_scores_reject_non_dict_inputs_without_crashing
    self.assertEqual(scored["manual_review"], "INVALID")
...
======================================================================
FAIL: test_manual_scores_reject_non_dict_inputs_without_crashing (test_quality.QualityTests.test_manual_scores_reject_non_dict_inputs_without_crashing) (manual=False)
----------------------------------------------------------------------
Traceback (most recent call last):
  File "E:\Projects\school\mathmodel\mathmodel-skill\tests\test_quality.py", line 394, in test_manual_scores_reject_non_dict_inputs_without_crashing
    self.assertEqual(scored["manual_review"], "INVALID")
...
----------------------------------------------------------------------
Ran 20 tests in 0.696s

FAILED (failures=4)
```

## Focused suite after fix
...
----------------------------------------------------------------------
Ran 20 tests in 0.741s

OK
```

## Complete suite after fix
